...
#       filename <- paste("C:/R-programms/Bastiaan_projects/FilterCandidates_With_ADF_minute_data/LLY ln equity.txt",sep="")
...
#                    && (IC1==IC2) && (RatioVerhouding < 3) && (IC1!=52593))
...

			{
                ...
                suppressWarnings(hh1<-BastiaanADF (testData,"c",1))
                
                crit<- -3.3
                stat1<-hh1@test$statistic
